/*************************************************************************
	> File Name: my_hash_table.h
	> Author: zxq
	> Mail: 1459190705@qq.com
	> Created Time: Sat 05 Feb 2022 07:59:21 PM CST
 ************************************************************************/
...
public:
    ...
    void swap(hashtable& rhs) {
        ...
        swap(this->hash, rhs.hash);
        swap(this->equals, rhs.equals);
        swap(this->num_elements, rhs.num_elements);
        return;
    }
